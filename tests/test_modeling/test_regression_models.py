...
from tests.fixtures.test_data import sample_spectra_data, sample_target_data, train_test_split_indices, sample_model_params


def test_train_regression_model(sample_spectra_data, sample_target_data, train_test_split_indices):
...
def test_evaluate_regression_model(sample_spectra_data, sample_target_data, train_test_split_indices):
...
def test_save_and_load_model(sample_spectra_data, sample_target_data, train_test_split_indices):
