            ...
            if args.plot_selection:
                ...
                if args.feature_selection == "ga":
                    ...
                    plot_path = os.path.join(
                        args.output, f"ga_selected_features_{timestamp}.png"
                    )
                    ...
                    plot_history_path = os.path.join(
                        args.output, f"cars_selection_history_{timestamp}.png"
                    )
                    ...
                    plot_wavelengths_path = os.path.join(
                        args.output, f"cars_selected_features_{timestamp}.png"
                    )
                    ...
                    plot_path = os.path.join(
                        args.output, f"vip_scores_{timestamp}.png"
                    )
                    plot.savefig(plot_path, dpi=300, bbox_inches="tight")
