...
def compare_models(
    ...
    # Sort by metric value (lower is better for rmse and mae, higher is better for r2 and explained_variance)
    ...
    ax.set_title(f'Model Comparison - {metric.upper()} on {dataset.capitalize()} Set')
